...
export function sandwichTrick(deck) {
    ...
    let middelIndex = deck.length /2;
    let middle = [bottom , top];
    const remaining = deck.slice(1 , -1);
    return [...remaining.slice(0 , middelIndex - 1) , ...middle , ...remaining.slice(middelIndex - 1)] 
